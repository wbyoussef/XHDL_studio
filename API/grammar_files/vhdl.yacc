...
;mode  : t_INOUT  /* No supported*/
;mode  : t_BUFFER /* No supported*/ 
;mode  : t_LINKAGE  /* No supported*/
...
;seq_stat : assertion_stat  /* not supported in XHDL*/
;seq_stat : case_stat  /* Not supported yet */
;seq_stat : exit_stat  /* Not supported in XHDL */
;seq_stat : if_stat  /* Not supported yet */
;seq_stat : loop_stat  /* Not supported in XHDL */
;seq_stat : next_stat  /* Not supported in XHDL */
;seq_stat : null_stat  /* Not supported in XHDL */
;seq_stat : procedure_call_stat   /* Not supported yet */
;seq_stat : return_stat  /* Not supported in XHDL */
;seq_stat : signal_assign_stat  
;seq_stat : variable_assign_stat /* variables are not supported */   
;seq_stat : wait_stat  /* not supported in RTL */ 
...
;signal_assign_stat_1  : t_TRANSPORT  /* not supported in rtl */
